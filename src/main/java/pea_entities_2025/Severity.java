...
public class Severity implements Serializable {
	...
	@Id
	@SequenceGenerator(name="SEVERITY_ID_GENERATOR", sequenceName="SEQ_GLOBAL")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SEVERITY_ID_GENERATOR")
