...
public class Shortinterruptionreading implements Serializable {
	...
	@Id
	@SequenceGenerator(name="SHORTINTERRUPTIONREADING_ID_GENERATOR", sequenceName="SEQ_GLOBAL")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="SHORTINTERRUPTIONREADING_ID_GENERATOR")
	...
	@OneToMany(mappedBy="shortinterruptionreading")
	private List<Outagereport> outagereports;

	public Shortinterruptionreading() {
	}
	...
	public Outagereport addOutagereport(Outagereport outagereport) {
		...
		outagereport.setShortinterruptionreading(this);
	...
	public Outagereport removeOutagereport(Outagereport outagereport) {
		...
		outagereport.setShortinterruptionreading(null);
