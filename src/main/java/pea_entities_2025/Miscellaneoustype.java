...
/**
 * The persistent class for the MISCELLANEOUSTYPE database table.
 * 
 */
@Entity
@Table(name="MISCELLANEOUSTYPE")
@NamedQuery(name="Miscellaneoustype.findAll", query="SELECT m FROM Miscellaneoustype m")
public class Miscellaneoustype implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="MISCELLANEOUSTYPE_ID_GENERATOR", sequenceName="SEQ_GLOBAL")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="MISCELLANEOUSTYPE_ID_GENERATOR")
	...
	@OneToMany(mappedBy="miscellaneoustype")
	...
	public Extraequipment addExtraequipment(Extraequipment extraequipment) {
		...
		extraequipment.setMiscellaneoustype(this);
	...
	public Extraequipment removeExtraequipment(Extraequipment extraequipment) {
		...
		extraequipment.setMiscellaneoustype(null);
