...
/**
 * The persistent class for the TASKREJECTREASON database table.
 * 
 */
@Entity
@Table(name="TASKREJECTREASON")
@NamedQuery(name="Taskrejectreason.findAll", query="SELECT t FROM Taskrejectreason t")
public class Taskrejectreason implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="TASKREJECTREASON_ID_GENERATOR", sequenceName="SEQ_GLOBAL")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="TASKREJECTREASON_ID_GENERATOR")
