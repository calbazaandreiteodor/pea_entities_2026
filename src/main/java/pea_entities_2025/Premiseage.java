...
public class Premiseage implements Serializable {
	...
	@Id
	@SequenceGenerator(name="PREMISEAGE_ID_GENERATOR", sequenceName="SEQ_GLOBAL")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="PREMISEAGE_ID_GENERATOR")
