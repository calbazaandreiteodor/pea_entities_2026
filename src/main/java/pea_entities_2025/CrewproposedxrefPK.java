...
/**
 * The primary key class for the CREWPROPOSEDXREF database table.
 * 
 */
@Embeddable
public class CrewproposedxrefPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CrewproposedxrefPK)) {
			return false;
		}
		CrewproposedxrefPK castOther = (CrewproposedxrefPK)other;
		return 
